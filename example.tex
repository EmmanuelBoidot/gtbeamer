...
\usetheme[dark,sectionToc,partToc]{GT} 
% dark: remove the dark option for golden frame titles
% partToc: for toc at the beginning of each Part
% sectionToc: for toc at the beginning of each section
